...
- [forecasting](https://github.com/JaumeAmoresDS/forecasting): this library intends to provide a uniform API 
...
Please note that, since the python modules are created using `nbdev`, there are some small comments automatically inserted across the python 
code. These small comments can be safely ignored, as they just act as small internal references used by `nbdev`. In the future, 
I intend to implement an extension of `nbdev` which avoids writing these comments.
<p></p>
